...
namespace OpenIddictSetUp.Controllers
{
    ...
    public class AuthorizationController : ControllerBase
    {
        ...
        public AuthorizationController(IOpenIddictClientConfigurationProvider clientConfigurationProvider, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IMemoryCacheService cacheService, AuthSettings authSettings, ILogger<AuthorizationController> logger)
        {
        ...
        protected virtual async Task<IActionResult> SignInUser(ApplicationUser user, OpenIddictRequest? request)
        {
            if (request == null)
            {
        ...
        /// </summary>
        protected virtual async Task AddClaims(ClaimsPrincipal principal, ApplicationUser user, OpenIddictRequest openIddictRequest)
        {
        ...
        /// </summary>
        protected virtual Task<IList<Claim>> GetClaims(ApplicationUser user, OpenIddictRequest openIddictRequest)
        {
